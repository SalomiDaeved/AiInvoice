...
import { invoicePreviewStyles } from "../assets/Styles.js";
...
function normalizeCurrency(currency) {
  ...
  // Convert old Indian currency values to Sri Lankan Rupees
  if (!cur || cur === "INR" || cur === "RS" || cur === "₹") {
    return "LKR";
  }
