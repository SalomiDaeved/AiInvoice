...
import { aiInvoiceModalStyles } from '../assets/Styles.js';
import GeminiIcon from './GeminiIcon';
import AnimateButton from '../assets/GenerateBtn/Gbtn.jsx';
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className={aiInvoiceModalStyles.description}>
              Paste any text that contains invoice details such as client,
              items, quantity, and prices, and we'll attempt to extract an invoice.
            </p>
          </div>
